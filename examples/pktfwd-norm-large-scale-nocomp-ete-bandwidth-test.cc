...
#define GRAPHIC_PREFIX "/home/harshal/results/prov_nocomp_bandwidth/"
...
void PrintPathToFile(vector<int>& path)
{
  ...
  std::ofstream outFile("/home/harshal/results/others/pathFile_nocomp.pt");
                         ...
                         map<int,int> rtables[MAX_NODE_NUM],int dataSize)
{
  ...
  hopCountFile.open ("/home/harshal/results/hopCount_nocomp.dat", ios::out | ios::app);
