...
#define GRAPHIC_PREFIX STORAGE_PATH"dns_rmitm_bandwidth_graphics/"
...
void PrintPathToFile(vector<int>& path)
{
  ...
  std::ofstream outFile(STORAGE_PATH"pathFile_rmitm.pt");
...
{
  LogComponentEnable("DnsProvDishHlistRMITM", LOG_LEVEL_INFO);
