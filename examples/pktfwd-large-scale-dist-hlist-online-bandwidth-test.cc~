...
#define linkhr(host, sw)\
  tuple(PktfwdNormDistHlistOnline::LINKHR,\
...
#define GRAPHIC_PREFIX "/home/harshal/results/prov_dist_online_bandwidth/"
...
void PrintPathToFile(vector<int>& path)
{
  ...
  std::ofstream outFile("/home/harshal/results/others/pathFile_online.pt");
                         ...
                         map<int,int> rtables[MAX_NODE_NUM],int dataSize)
{
  ...
  hopCountFile.open ("/home/harshal/results/hopCount_online.dat", ios::out | ios::app);
