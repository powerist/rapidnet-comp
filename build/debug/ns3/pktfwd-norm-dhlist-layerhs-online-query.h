...
#ifndef PKTFWDNORMDHLISTLAYERHSONLINEQUERY_H
#define PKTFWDNORMDHLISTLAYERHSONLINEQUERY_H
...
class PktfwdNormDhlistLayerhsOnlineQuery : public RapidNetApplicationBase
{
public:
  ...
  static const string RECVPACKETQRYPROV;
  static const string RULEEXEC;
  static const string RULEQUERY;

  static TypeId GetTypeId (void);

  PktfwdNormDhlistLayerhsOnlineQuery ();

  virtual ~PktfwdNormDhlistLayerhsOnlineQuery ();
...
protected:
  ...
  virtual void R02Eca1Ins (Ptr<Tuple> flowEntry);
  ...
  virtual void Rv8_eca (Ptr<Tuple> baseReturn);

  virtual void Rv9_eca (Ptr<Tuple> rReturn);

  virtual void Rv10Eca0Ins (Ptr<Tuple> rResultTmp);

  virtual void Rv10Eca1Ins (Ptr<Tuple> rQList);

  virtual void Rv11_eca (Ptr<Tuple> eRReturn);

  virtual void Q0Eca0Ins (Ptr<Tuple> recvPacketQry);

  virtual void Q1_eca (Ptr<Tuple> recvPacketQryProv);
...
#endif // PKTFWDNORMDHLISTLAYERHSONLINEQUERY_H
