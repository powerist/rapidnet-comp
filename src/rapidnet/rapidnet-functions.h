...
namespace ns3 {
  namespace rapidnet {
     ...
     * \ingroup rapidnet_functions
     *
     * \brief A RapidNet function that joins a list with list, or an element with list,
     *        or a list with element.
     */
    class FJoin : public FunctionExpr
    {
    public:
      ...
      static Ptr<FunctionExpr> New (Ptr<Expression> val1, Ptr<Expression> val2);

    protected:

      Ptr<Expression> m_val1, m_val2;
    };

    /**
     * \ingroup rapidnet_functions
     *
     * \brief A RapidNet function that returns the ith element of a list.
    ...
    public:
      ...
      static Ptr<FunctionExpr> New (Ptr<Expression> listAttrName, Ptr<Expression> loc);

    protected:

      Ptr<Expression> m_loc;
     ...
     * \ingroup rapidnet_functions
     *
     * \brief A RapidNet function that removes an element of a list.
     * 1-based indexing used
     */
    class FPopFront : public FunctionExpr
    {
    public:
      virtual ~FPopFront() {}
      virtual Ptr<Value> Eval (Ptr<Tuple> tuple);
      static Ptr<FunctionExpr> New (Ptr<Expression> list);
    private:
     ...
     * \ingroup rapidnet_functions
     *
     * \brief A RapidNet function that duplicates  a list.
     * 1-based indexing used
     */
    class FDupList : public FunctionExpr
    {
    public:
      virtual ~FDupList() {}
      virtual Ptr<Value> Eval (Ptr<Tuple> tuple);
    ...
    class FInitList : public FunctionExpr
    {
    public:
      virtual ~FInitList() {}
      virtual Ptr<Value> Eval (Ptr<Tuple> tuple);
     ...
     *        a list.
     */
    class FDisjoint : public FunctionExpr
    {
    public:
