...
#ifndef PKTFWDNORMPROVENABLED_H
#define PKTFWDNORMPROVENABLED_H
...
class PktfwdNormProvEnabled : public RapidNetApplicationBase
{
public:
  ...
  PktfwdNormProvEnabled ();

  virtual ~PktfwdNormProvEnabled ();
